...
public class UploadConstant {
     ...
     * 上传文件存储-根路径
     */
    public static final String UPLOAD_PATH_ROOT = PropertyUtils.getString("upload.path.root");
    /**
     * 静态文件host
     */
    public static final String UPLOAD_SERVER_HOST = PropertyUtils.getString("upload.server.host");
    /**
